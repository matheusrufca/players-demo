...
angular
	...
	.factory('clapprInfo', function () {
		return {
			title: 'Clappr',
			url: 'https://github.com/clappr/clappr',
			git: 'https://github.com/clappr/clappr',
			description: 'An extensible media player for the web. http://clappr.io'
		};
	})
	.controller("ClapprController", ['$rootScope', '$scope', '$http', 'broadcastService', 'streamsService', 'Notification', 'clapprInfo',
		function ($rootScope, $scope, $http, broadcastService, streamsService, logService, playerInfo) {
			...
			$scope.$on('player:loaded', function (event, data) {
